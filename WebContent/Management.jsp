...
<div class="main">
	<div class="mainbox">
		...
		<b style="color:red">※入荷数は、1000以内の半角数字（正の数）のみ入力可能です。<br>全商品総点数1万を越える数の商品は入れられません。</b>
		<br><br><br>
		<s:if test="ErrorCount>0">
        <p style="color:#DC143C; font-size:20px; font-weight:bold;"><s:property value="message" escape="false" /></p>
      </s:if>
	</div>
	<br><br>
		<!-- 在庫追加確認ページに飛ばします。 -->
